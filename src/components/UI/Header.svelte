...
<header class="mb-4">
    <div class="flex p-1 w-full justify-between items-center">
        <h1
            class="p-1 sm:text-5xl text-4xl italic font-medium text-light-text dark:text-dark-text"
        >
            {title}
        </h1>
    ...
    >
        <div class="w-1/2 sm:w-1/3 mr-1"><slot name="slot4" /></div>
        <div class="w-1/2 sm:w-1/3"><slot name="slot5" /></div>
    </div>
</header>
